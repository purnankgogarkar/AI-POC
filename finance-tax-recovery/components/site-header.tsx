      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="text-sm font-semibold tracking-tight">Verify</div>
            <div className="hidden text-xs text-muted-foreground sm:block">Invoice Tax Validation &amp; Recovery</div>
          </div>
        </div>
